...
const HermelindaSvg = () => {
  ...
  function pintarMama() {
    ...
    let setInt = setInterval(function () {
      ...
      paths[147].style.fill = color;
      paths[146].style.fill = color;
      paths[145].style.fill = color;
      paths[225].style.fill = color;
      paths[227].style.fill = color;
      paths[226].style.fill = color;
      paths[262].style.fill = color;
      paths[144].style.fill = color;
      paths[224].style.fill = color;
      paths[223].style.fill = color;
      paths[222].style.fill = color;
      if (i === paths.length - 1) {
  ...
  function pintarMamaCiclos() {
    pintarMamaCiclo();
    return setInterval(pintarMamaCiclo, 1515);
  }
  ...
  useEffect(() => {
    if (isAnimationOn) {
      ...
      const newSetIntervalId = pintarMamaCiclos();
      setIntervalId(newSetIntervalId);
    }
  }, [isAnimationOn]);
  ...
  return (
    <DivSvgHermelinda>
      ...
      <DivSvgHermelindaBtn onClick={hermeToggle}>
...
const DivSvgHermelindaBtn = styled.div`
  display: flex;
  justify-content: center;
  button {
