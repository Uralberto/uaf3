...
const HermelindaSvg = () => {
  ...
  const gRefUno = useRef();
  const gRefDos = useRef();
  const gRefTres = useRef();

  // Define transform-box y transform-origin

  const definirTransform = () => {
    const pathsUno = gRefUno.current.children;
    const pathsDos = gRefDos.current.children;
    const pathsTres = gRefTres.current.children;
    for (let i = 0; i <= pathsUno.length - 1; i++) {
      pathsUno[i].style.transformBox = "fill-box";
      pathsUno[i].style.transformOrigin = "center";
      pathsDos[i].style.transformBox = "fill-box";
      pathsDos[i].style.transformOrigin = "center";
      pathsTres[i].style.transformBox = "fill-box";
      pathsTres[i].style.transformOrigin = "center";
    }
  };

  ////////////// Animacion "Escalar", achica el tamaño de las piezas (paths) y luego regresan a su tamaño original
  const escalarPaths = (scale, delay) => {
    gRefUno.current.style.display = "flex";
    gRefDos.current.style.display = "none";
    gRefTres.current.style.display = "none";
    const pathsUno = gRefUno.current.children;
  ...
  ////////////// Animacion "Rotar", rota cada pieza (paths) y al tiempo rota tod el conjunto de piezas
  ...
  const rotarPaths = () => {
    ...
    for (let i = 0; i <= pathsUno.length - 1; i++) {
      ...
      (pathsUno[i].style.transformOrigin = toX), toY;
  ...
  ////////////// Animacion "Dispersar", desordena y dispersa las piezas (paths) /////////////////
  /////////////////////////////////////////////////////////////////////////////////
  const girarPaths = (duracion, delay, rotate) => {
    gRefUno.current.style.display = "flex";
    const pathsUno = gRefUno.current.children;
    for (let i = 0; i <= pathsUno.length - 1; i++) {
      pathsUno[i].animate([{ transform: `rotateZ(${rotate}deg)` }], {
        duration: duracion,
        fill: "forwards",
        easing: "ease-out",
        delay: delay,
  ...
  const trasladarPathsX = (duracion, delay, px) => {
    gRefDos.current.style.display = "flex";
    const pathsDos = gRefDos.current.children;
    for (let i = 0; i <= pathsDos.length - 1; i++) {
      let n = 1;
      let f = Math.random();
      if (f < 0.5) {
        n = -2;
      }
      let translate = `translateX(${px * f * n}px)`;
      pathsDos[i].animate([{ transform: translate }], {
        duration: duracion,
        fill: "forwards",
        easing: "ease-in-out",
        delay: delay,
  ...
  const trasladarPathsY = (duracion, delay, py) => {
    gRefTres.current.style.display = "flex";
    const pathsTres = gRefTres.current.children;
    for (let i = 0; i <= pathsTres.length - 1; i++) {
      let n = 1;
      let f = Math.random();
      if (f < 0.5) {
        n = -2;
      }
      let translate = `translateY(${py * f * n}px)`;

      pathsTres[i].animate([{ transform: translate }], {
        duration: duracion,
        fill: "forwards",
        easing: "ease-in-out",
        delay: delay,
  ...
  useEffect(() => {
    if (isAnimationTresOn) {
      definirTransform();
      girarPaths(6000, 0, 500, 0.2);
      girarPaths(6000, 6000, 0, 0);

      trasladarPathsX(6000, 0, -600);
      trasladarPathsX(6000, 6000, 0);

      trasladarPathsY(6000, 0, 600);
      trasladarPathsY(6000, 6000, 0);
    } else {
    }
  }, [isAnimationTresOn]);

  ////////////// Animacion "Desvanecer", rota casi 90° los paths con la idea de que se vean como una linea /////////////////
  /////////////////////////////////////////////////////////////////////////////////

  const desvanecerPaths = (rotate, delay) => {
    gRefUno.current.style.display = "flex";
    gRefDos.current.style.display = "none";
    gRefTres.current.style.display = "none";
    const pathsUno = gRefUno.current.children;

    for (let i = 0; i <= pathsUno.length * 0.33 - 1; i++) {
      pathsUno[i].animate([{ transform: `rotateX(${rotate}deg)` }], {
        duration: 4000,
        fill: "forwards",
        easing: "ease-out",
        delay: delay,
    ...
    for (
      let i = pathsUno.length * 0.33 - 1;
      i <= pathsUno.length * 0.66 - 1;
      i++
    ) {
      pathsUno[i].animate([{ transform: `rotateY(${rotate}deg)` }], {
        duration: 4000,
        fill: "forwards",
        easing: "ease-out",
        delay: delay,
    ...
    for (let i = pathsUno.length * 0.66 - 1; i <= pathsUno.length - 1; i++) {
      pathsUno[i].animate([{ transform: `rotateX(${rotate}deg)` }], {
        duration: 4000,
        fill: "forwards",
        easing: "ease-out",
  ...
  useEffect(() => {
    if (isAnimationCuatroOn) {
      definirTransform();
      desvanecerPaths(88.5, 0);
      desvanecerPaths(0, 7000);
    } else {
    }
  }, [isAnimationCuatroOn]);
        ...
        <G ref={gRefUno}>
          ...
          <g>
            <path
              ...
              transform="translate(-939.708 -426)"
              fill="#302f2f"
              stroke="#302f2f"
              strokeWidth="0.1"
            />
          ...
          <g>
            <path
              ...
              transform="matrix(0.985, -0.174, 0.174, 0.985, -1057.034, -226.493)"
              fill="#333"
              stroke="#333"
              strokeWidth="1"
            />
          ...
          <g>
            <path
              ...
              transform="translate(-940.158 -426.434)"
              fill="#544e4e"
              stroke="#544e4e"
              strokeWidth="1"
            />
...
to{
    transform: scale(.22) translate(35px, 15px);
}  

`;

const DivSvgHermelinda = styled.div`
  width: 100%;
  display: flex;
...
const SvgHermelinda = styled.svg`
  width: 100%;
...
const G = styled.g`
  stroke-width: 0.1px;
  transform: scale(0);
  animation: ${escalar} 0s ease-out forwards;
`;
